...
# Copiar el archivo de comandos asadmin para configurar los recursos (Pool de conexiones y Data Source)
COPY --chown=payara:payara glassfish-resources.asadmin $POSTBOOT_COMMANDS

# Copiar el archivo .war para su despliegue como aplicación principal (ROOT.war) en el autodeploy del dominio
